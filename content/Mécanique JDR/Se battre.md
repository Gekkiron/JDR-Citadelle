Pour comprendre comment se battre dans ce JDR, il faut juste se dire qu’un combat est une suite [[Réaliser une action|d’action à réaliser]].
...
- Les points de A sont bien supérieur aux points de B -> l’attaque passe et suivant la description faite, le MJ déterminera l’étendu des dommages
- Les points de A sont dans le même ordre de grandeur que les points de B -> A lance un dé 20 : 
	...
	- Si le résultat est entre 11 et 15 -> L’attaque réussi en donnant une possibilité de défense
	- Si le résultat est entre 16 et 20 -> L‘attaque réussi et suivant la description faite, le MJ déterminera l’étendu des dommages
...
Comme vous pouvez le constater, l’appréciation de la situation par le MJ peut être déterminant, après libre à vous de le faire chier.
...
Pour en savoir plus sur le déplacement : [[Se déplacer en combat]] 
Pour en savoir sur les compétences et sort : [[Utiliser une compétence ou un sort#En combat|Utiliser une compétence ou un sort en combat]] 

L’effet de surprise, les blessures, les compétences, etc.. sont évidement des paramètres pouvant influé sur l’ordre.
...
- Si le résultat est entre 11 et 17 -> La défense réussi, l’allié ne se prend pas l’offensive -> on passe dans la phase ***Se défendre*** 
