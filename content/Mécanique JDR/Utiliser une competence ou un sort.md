---
title: Utiliser une compétence ou un sort
aliases:
...
Les [[Competence|Compétences]] passives ne consomment pas de [[Mana]].
...
Sort tour 2 nécessite un tour de charge pour pouvoir être lancé. Pendant le chargement, la personne ne peut rien faire.

Dans la phase actions rapides, il n’y a pas de limite aux nombres de compétences et de sort rapide que le joueur peut utiliser (en dehors de celle du mana)

## Hors tour

Pour se défendre, une personne peut utiliser une compétence ou un sort rapide.